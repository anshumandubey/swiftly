...
from view_comps.gauge import GaugeDraw
...
pygame.font.init()
font_28 = pygame.font.Font(os.path.join('./view_comps/fonts/digitize.ttf'), 28)
font_60 = pygame.font.Font(os.path.join('./view_comps/fonts/digitize.ttf'), 60)
